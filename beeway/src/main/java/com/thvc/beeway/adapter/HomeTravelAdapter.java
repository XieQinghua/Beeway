...
public class HomeTravelAdapter extends BaseAdapter {
    private List<HomeBean.DataEntity.TravelEntity> list;
    private BitmapUtils bitmapUtils;
    private ImageLoader imageLoader;
    private Context context;
    private com.nostra13.universalimageloader.core.ImageLoader imageLoader2;

    public HomeTravelAdapter(List<HomeBean.DataEntity.TravelEntity> list, Context
            context) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vh.collection = (TextView) convertView.findViewById(R.id.travel_fragment_item_collection);
    ...
    class ViewHolder {
        TextView name, time, content, share, good, comment, collection, tv_user_sex, tv_user_rank;
