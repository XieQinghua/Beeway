...
public class TimeCountUtil extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        btn.setText("获取验证码（" + millisUntilFinished / 1000+"）");//设置倒计时时间

        //设置按钮为灰色，这时是不能点击的
//        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.de_btn_login_sign_in));
...
//        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.de_btn_login_sign_in));//还原背景色
