package com.thvc.beeway.photos;
...
public class NewImageGridActivity extends Activity {
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 0:
				Toast.makeText(NewImageGridActivity.this, "最多选择9张图片", Toast.LENGTH_SHORT).show();
				break;
			case 1:
				Toast.makeText(NewImageGridActivity.this, "最多选择1张图片", Toast.LENGTH_SHORT).show();
				break;
	...
	private void initView() {
		...
		adapter.setTextCallback(new NewImageGridAdapter.TextCallback() {
