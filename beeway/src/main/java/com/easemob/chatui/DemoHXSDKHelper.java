...
public class DemoHXSDKHelper extends HXSDKHelper {
        ...
        return new HXNotifier.HXNotificationInfoProvider() {
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                if (robotMap != null && robotMap.containsKey(message.getFrom())) {
                    ...
                    /**根据usename匹配本地好友获得昵称（尝试不网络获取，提高性能）*/
                    FriendDao friendDao = new FriendDao(context);
                    Friend friend = friendDao.getFriend(message.getFrom());
                    return friend.getTitle() + ": " + ticker;
                }
            }
    ...
    protected HXSDKModel createModel() {
        return new com.easemob.chatui.DemoHXSDKModel(appContext);
    }
        ...
        return new HXNotifier() {
            public synchronized void onNewMsg(final EMMessage message) {
                ...
                if (message.getChatType() == ChatType.Chat) {
                    ...
                    notNotifyIds = ((com.easemob.chatui.DemoHXSDKModel) hxModel).getDisabledGroups();
                } else {
                    chatUsename = message.getTo();
                    notNotifyIds = ((com.easemob.chatui.DemoHXSDKModel) hxModel).getDisabledIds();
                }
     ...
     */
    public com.easemob.chatui.DemoHXSDKModel getModel() {
        return (com.easemob.chatui.DemoHXSDKModel) hxModel;
    }
    ...
    public Map<String, User> getContactList() {
        if (getHXId() != null && contactList == null) {
            contactList = ((com.easemob.chatui.DemoHXSDKModel) getModel()).getContactList();
        }
    ...
    public Map<String, RobotUser> getRobotList() {
        if (getHXId() != null && robotList == null) {
            robotList = ((com.easemob.chatui.DemoHXSDKModel) getModel()).getRobotList();
        }
        return robotList;
    }
