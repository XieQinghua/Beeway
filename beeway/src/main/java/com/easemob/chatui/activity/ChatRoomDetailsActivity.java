...
public class ChatRoomDetailsActivity extends BaseActivity implements OnClickListener {
	...
	public void exitGroup(View view) {
		startActivityForResult(new Intent(this, com.easemob.chatui.activity.ExitGroupDialog.class), REQUEST_CODE_EXIT);
	...
	public void exitDeleteGroup(View view) {
		startActivityForResult(new Intent(this, com.easemob.chatui.activity.ExitGroupDialog.class).putExtra("deleteToast", getString(R.string.dissolution_group_hint)),
