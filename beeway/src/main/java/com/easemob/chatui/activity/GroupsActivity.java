...
public class GroupsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		groupListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				if (position == 1) {
					// 新建群聊
					startActivityForResult(new Intent(GroupsActivity.this, com.easemob.chatui.activity.NewGroupActivity.class), 0);
				} else if (position == 2) {
					// 添加公开群
					startActivityForResult(new Intent(GroupsActivity.this, com.easemob.chatui.activity.PublicGroupsActivity.class), 0);
				} else {
					// 进入群聊
	...
	public void onPublicGroups(View view) {
		startActivity(new Intent(this, com.easemob.chatui.activity.PublicGroupsActivity.class));
	}
