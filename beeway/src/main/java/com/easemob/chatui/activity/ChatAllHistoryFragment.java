...
public class ChatAllHistoryFragment extends Fragment implements OnClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (username.equals(BeewayApplication.getInstance().getUserName()))
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        // 更新消息未读数
        ((com.thvc.beeway.fragment.DialogFragment) getActivity()).updateUnreadLabel();
    ...
    public void onResume() {
        super.onResume();
        if (!hidden && !((DialogFragment) getActivity()).isConflict) {
            refresh();
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (((DialogFragment) getActivity()).isConflict) {
            outState.putBoolean("isConflict", true);
        } else if (((DialogFragment) getActivity()).getCurrentAccountRemoved()) {
