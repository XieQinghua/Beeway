...
//        idText.setText(groupId);
        idText.setText(group.getGroupName());
                    ...
                    button.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            startActivityForResult(
                                    (new Intent(GroupDetailsActivity.this, com.easemob.chatui.activity.GroupPickContactsActivity.class).putExtra("groupId", groupId)),
...
//                UserUtils.getBeewayNickname(getContext(), username, holder.textView);
//                holder.textView.setText(username);
                /**根据userid向服务器请求获得群成员昵称*/
                HttpUtils httpUtils = new HttpUtils();
                MyRequestParams params = new MyRequestParams();
                params.addQueryStringParameter("userid", BeewayApplication.getInstance().getmUserid(getContext()));
                params.addQueryStringParameter("friendid", username);
                ...
                httpUtils.send(HttpRequest.HttpMethod.POST, UrlPools.USER_DETAIL + "?" + url, new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        holder.textView.setText(userDetailBean.getData().getFriend().getNickname());
                    }
                ...
                button.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (isInDeleteMode) {
                            ...
                            // 点击user，可以进入用户详情
                            startActivity(new Intent(GroupDetailsActivity.this, UserDetailsActivity.class).putExtra("friendid", username));
