...
import com.easemob.chatui.domain.VideoEntity;
import com.easemob.chatui.video.util.ImageCache;
import com.easemob.chatui.video.util.ImageResizer;
import com.easemob.chatui.video.util.Utils;
import com.easemob.chatui.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			intent.setClass(getActivity(), com.easemob.chatui.activity.RecorderVideoActivity.class);
