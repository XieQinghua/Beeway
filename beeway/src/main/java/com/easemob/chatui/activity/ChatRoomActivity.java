...
import com.easemob.chatui.adapter.ChatRoomAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		chatListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				if(position == 1) {
					// 添加公开群
					startActivityForResult(new Intent(ChatRoomActivity.this, com.easemob.chatui.activity.PublicChatRoomsActivity.class), 0);
				} else {
					// 进入群聊
