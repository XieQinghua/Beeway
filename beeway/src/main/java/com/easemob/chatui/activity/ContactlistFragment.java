...
public class ContactlistFragment extends Fragment {
    ...
    class HXContactSyncListener implements HXSDKHelper.HXSyncListener {
        public HXContactSyncListener() {

            LogUtils.i("HXContactSyncListener" + "已经创建好了");
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (Constant.NEW_FRIENDS_USERNAME.equals(username)) {
                    ...
                    startActivity(new Intent(getActivity(), com.easemob.chatui.activity.NewFriendsMsgActivity.class));
                } else if (Constant.GROUP_USERNAME.equals(username)) {
                    /** 进入群组列表页面*/
                    startActivity(new Intent(getActivity(), com.easemob.chatui.activity.GroupsActivity.class));
                } else {
                    /** 进入用户详情页*/
                    startActivity(new Intent(getActivity(), UserDetailsActivity.class).putExtra("friendid", adapter.getItem(position).getUsername()));
                }
            }
        });
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    params.addQueryStringParameter("userid", BeewayApplication.getInstance().getmUserid(getActivity()));
...
//                        params.addBodyParameter("iden", iden);
     ...
     * @param result
     */
    public DelBean paraseDelData(String result) {
        Gson gson = new Gson();
        DelBean delBean = gson.fromJson(result, DelBean.class);
        return delBean;
    }
    ...
    private void getContactList() {
        contactList.clear();
        //获取本地好友列表
        Map<String, User> users = BeewayApplication.getInstance().getContactList();
        ...
        Collections.sort(contactList, new Comparator<User>() {
            ...
            public int compare(User lhs, User rhs) {
                /**匹配本地好友做排序*/
                FriendDao friendDao = new FriendDao(getActivity());
//                return (friendDao.getFriend(lhs.getUsername()).getTitle()).compareTo(friendDao.getFriend(rhs.getUsername()).getTitle());
                return (friendDao.getFriend(lhs.getUsername()).getLetter()).compareTo(friendDao.getFriend(rhs.getUsername()).getLetter());
