...
public class SmileUtils {
	...
	public static final String e_1 = "[闭嘴]";
	public static final String e_2 = "[呲牙]";
	public static final String e_3 = "[调皮]";
	public static final String e_4 = "[流汗]";
	public static final String e_5 = "[偷笑]";
	public static final String e_6 = "[再见]";
	public static final String e_7 = "[敲打]";
		public static final String e_8 = "[擦汗]";
		public static final String e_9 = "[猪头]";
		public static final String e_10 = "[玫瑰]";
	public static final String e_11 = "[流泪]";
	public static final String e_12 = "[大哭]";
	public static final String e_13 = "[嘘]";
	public static final String e_14 = "[酷]";
	public static final String e_15 = "[抓狂]";
		public static final String e_16 = "[委屈]";
	public static final String e_17 = "[便便]";
	public static final String e_18 = "[炸弹]";
	public static final String e_19 = "[菜刀]";
	public static final String e_20 = "[愉快]";
	public static final String e_21 = "[色]";
		public static final String e_22 = "[害羞]";
	public static final String e_23 = "[害羞]";
	public static final String e_24 = "[吐]";
	public static final String e_25 = "[微笑]";
	public static final String e_26 = "[发怒]";
	public static final String e_27 = "[尴尬]";
		public static final String e_28 = "[惊恐]";
	public static final String e_29 = "[冷汗]";
	public static final String e_30 = "[爱心]";
	public static final String e_31 = "[嘴唇]";
	public static final String e_32 = "[白眼]";
	public static final String e_33 = "[傲慢]";
	public static final String e_34 = "[难过]";
	public static final String e_35 = "[惊讶]";

	public static final String e_36 = "[疑问]";
	public static final String e_37 = "[睡]";
	public static final String e_38= "[亲亲]";
	public static final String e_39 = "[憨笑]";
	public static final String e_40 = "[爱情]";
	public static final String e_41 = "[衰]";
	public static final String e_42 = "[撇嘴]";
	public static final String e_43 = "[阴险]";
	public static final String e_44 = "[奋斗]";
	public static final String e_45 = "[发呆]";
	public static final String e_46 = "[右哼哼]";
	public static final String e_47 = "[拥抱]";
	public static final String e_48 = "[坏笑]";
	public static final String e_49 = "[飞吻]";
	public static final String e_50 = "[鄙视]";
	public static final String e_51 = "[晕]";
	public static final String e_52 = "[悠闲]";
	public static final String e_53 = "[可伶]";
	public static final String e_54= "[强]";
	public static final String e_55 = "[弱]";
	public static final String e_56= "[握手]";
	public static final String e_57 = "[胜利]";
	public static final String e_58= "[握拳]";
	public static final String e_59= "[凋谢]";
	public static final String e_60 = "[米饭]";
	public static final String e_61 = "[生日快乐]";
	public static final String e_62 = "[西瓜]";
	public static final String e_63 = "[啤酒]";
	public static final String e_64 = "[瓢虫]";
	public static final String e_65 = "[勾引]";
	public static final String e_66 = "[OK]";
	public static final String e_67 = "[爱你]";
	public static final String e_68 = "[咖啡]";
	public static final String e_69 = "[月亮]";
	public static final String e_70 = "[刀]";
	public static final String e_71 = "[发抖]";
	public static final String e_72 = "[差劲]";
	public static final String e_73= "[拳头]";
	public static final String e_74 = "[心碎]";
	public static final String e_75 = "[阳光]";
	public static final String e_76 = "[礼物]";
	public static final String e_77 = "[足球]";
	public static final String e_78 = "[骷髅]";
	public static final String e_79 = "[投降]";
	public static final String e_80 = "[闪电]";
	public static final String e_81= "[饥饿]";
	public static final String e_82 = "[困]";
	public static final String e_83 = "[咒骂]";
	public static final String e_84 = "[疯了]";
	public static final String e_85 = "[扣鼻]";
	public static final String e_86 = "[鼓掌]";
	public static final String e_87 = "[糗大了]";
	public static final String e_88 = "[左哼哼]";
	public static final String e_89 = "[哈欠]";
	public static final String e_90= "[快哭了]";
	public static final String e_91 = "[吓]";
	public static final String e_92 = "[篮球]";
	public static final String e_93 = "[乒乓球]";
	public static final String e_94 = "[NO]";
	public static final String e_95 = "[跳跳]";
	public static final String e_96= "[怄火]";
	public static final String e_97 = "[转圈]";
	public static final String e_98= "[磕头]";
	public static final String e_99= "[回头]";
	public static final String e_100 = "[跳绳]";
