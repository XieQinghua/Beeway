...
package com.easemob.chatui.video.util;
...
import com.thvc.beeway.BuildConfig;
...
public class ImageCache {
	...
	private void init(ImageCacheParams cacheParams) {
		...
		if (mCacheParams.memoryCacheEnabled) {
			...
			// bitmaps).
			if (com.easemob.chatui.video.util.Utils.hasHoneycomb()) {
			...
			mMemoryCache = new LruCache<String, BitmapDrawable>(
				...
				protected void entryRemoved(boolean evicted, String key,
					...
					if (com.easemob.chatui.video.util.RecyclingBitmapDrawable.class.isInstance(oldValue)) {
						// The removed entry is a recycling drawable, so notify
						// it
						// that it has been removed from the memory cache
						((com.easemob.chatui.video.util.RecyclingBitmapDrawable) oldValue).setIsCached(false);
					} else {
	...
	public void addBitmapToCache(String data, BitmapDrawable value) {
		...
		if (mMemoryCache != null) {
			if (com.easemob.chatui.video.util.RecyclingBitmapDrawable.class.isInstance(value)) {
				// The removed entry is a recycling drawable, so notify it
				// that it has been added into the memory cache
				((com.easemob.chatui.video.util.RecyclingBitmapDrawable) value).setIsCached(true);
			}
...
//		}
		...
		if (com.easemob.chatui.video.util.Utils.hasHoneycombMR1()) {
	...
	public static boolean isExternalStorageRemovable() {
		if (com.easemob.chatui.video.util.Utils.hasGingerbread()) {
